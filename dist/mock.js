	...
	*/
	...
	/*
	    ...
	    * Mock.mock( rurl, rtype, function(options) )
	    ...
	    根据数据模板生成模拟数据。
	*/
	Mock.mock = function(rurl, rtype, template, re_flag) {
	    // Mock.mock(template)
	...
	*/
	...
	Util.extend(MockXMLHttpRequest.prototype, {
	    ...
	    open: function(method, url, async, username, password) {
	        ...
	        ///////////zeng
	        this.custom.isReGet = !!item.re_flag;
	    },
	    ...
	    send: function send(data) {
	        ...
	        function done() {
	            ...
	            //////////////zeng
	            if(that.custom.isReGet) {
	                var re_get_url = that.custom.template.template(that.custom.options);
	                //console.log('re_get_url =   ' + re_get_url);
	                _getXhr().sendHTTP({
	                    method: 'GET',
	                    url: re_get_url,
	                    callback: function(mockjson) {
	                        that.response = that.responseText =  JSON.stringify(MockXMLHttpRequest.Mock.mock(mockjson));
